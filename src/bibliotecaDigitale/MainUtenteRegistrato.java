...
public class MainUtenteRegistrato {
	...
	public static void main(String[] args) {
		...
		System.out.println("UTENTE REGISTRATO " + regUser2.getNome() + " " + regUser2.getCognome() + ", "
				+ regUser2.getCodiceFiscale() + ". TESSERA NUM: " + regUser2.getIdTessera());

		Utente regUser3 = GestoreUtenti.getInstance().creaUtente(new UtenteRegistrato(nome, cognome, codiceFiscale));
		System.out.println("UTENTE REGISTRATO " + regUser3.getNome() + " " + regUser3.getCognome() + ", "
				+ regUser3.getCodiceFiscale() + ". TESSERA NUM: " + regUser3.getIdTessera());

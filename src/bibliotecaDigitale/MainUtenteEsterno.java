...
public class MainUtenteEsterno {
	...
	public static void main(String[] args) {
		...
		System.out.println("USER " + user2.getNome() + " " + user2.getCognome() + ", " + user2.getCodiceFiscale()
				+ ". TESSERA NUM: " + user2.getIdTessera());

		Utente user3 = GestoreUtenti.getInstance().creaUtente(new UtenteEsterno());
		System.out.println("USER " + user3.getNome() + " " + user3.getCognome() + ", " + user3.getCodiceFiscale()
				+ ". TESSERA NUM: " + user3.getIdTessera());
